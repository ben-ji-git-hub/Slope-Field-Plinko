...
public void reference_click1(GButton source, GEvent event) { //_CODE_:Tutorial:466569:
  backButton.setVisible(true);
  pauseButton.setVisible(false);
  source.setVisible(false);
  Classic_Mode.setVisible(false);
...
} //_CODE_:Tutorial:466569:

public void textarea2_change1(GTextArea source, GEvent event) { //_CODE_:tutorialText:724299:
  // println("tutorialText - GTextArea >> GEvent." + event + " @ " + millis());
} //_CODE_:tutorialText:724299:

public void pause_click1(GImageButton source, GEvent event) { //_CODE_:pauseButton:750660:
  timePause = !timePause;
} //_CODE_:pauseButton:750660:
...
public void createGUI(){
  ...
  DIFF_EQ = new GTextField(this, 100, 810, 600, 30, G4P.SCROLLBARS_NONE);
  ...
  textarea1.setText("Welcome to Slope Field Plinko, the first strategic, calculus-based version of everyone's favorite game-show minigame! Test your knowledge of differential equations defined in x and y to generate a slope field which will guide the plinko ball to its target! Type the differential equation into the box and watch the slope field change before your eyes. Try some familiar differential equations first (y'=1, y'=x+y, y'=sin(x), for starters), but don't be afraid to get creative! Before playing, please read the tutorial.");
  ...
  Tutorial = new GButton(this, 250, 645, 300, 150);
  Tutorial.setText("Tutorial");
  Tutorial.addEventHandler(this, "reference_click1");
  tutorialText = new GTextArea(this, 25, 100, 750, 775, G4P.SCROLLBARS_NONE);
  tutorialText.setOpaque(true);
  tutorialText.addEventHandler(this, "textarea2_change1");
  pauseButton = new GImageButton(this, 715, 810, 30, 30, new String[] { "play-icon-png-white.png", "play-icon-png-white.png", "play-icon-png-white.png" } );
